...
{
    public class LojaWebApiSevice
    {
        private LojaWebApiContext _context;

        public LojaWebApiSevice(LojaWebApiContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Departamento d2 = new Departamento(2, "Linha Branca");
            Departamento d3 = new Departamento(3, "Eletro Portáteis");
